...
const categoryData = [
  { name: 'Electronics', value: 35, color: '#006A4E' },
...
const summaryCards = [
  { label: 'Total Revenue', value: '$691,000', change: '+14.2%', icon: DollarSign, color: 'bg-[#E8F4F0]0' },
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={monthlyRevenue} barGap={2}>
              ...
              <Bar dataKey="revenue" fill="#006A4E" radius={[4, 4, 0, 0]} name="Revenue" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <ResponsiveContainer width="100%" height={280}>
            <AreaChart data={weeklyTraffic}>
              ...
              <Legend wrapperStyle={{ fontSize: '12px' }} />
              <Area type="monotone" dataKey="visitors" stroke="#006A4E" fill="#006A4E" fillOpacity={0.15} name="Visitors" />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <LineChart data={monthlyRevenue}>
            ...
            <Line type="monotone" dataKey="revenue" stroke="#006A4E" strokeWidth={1.5} strokeDasharray="5 5" dot={false} name="Revenue" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
