...
const channelData = [
  { name: 'Direct', value: 35, color: '#006A4E' },
...
const statusBadge: Record<string, string> = {
  ...
  processing: 'bg-emerald-100 text-[#00553f] dark:bg-emerald-900/30 dark:text-emerald-400',
};
...
export const DashboardPage: React.FC = () => {
  ...
  const stats = [
    { title: 'Total Users', value: '2,543', change: 12.5, type: 'increase' as const, icon: Users, color: 'text-[#006A4E]', lightBg: 'bg-[#E8F4F0] dark:bg-emerald-900/20' },
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <select className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-[#006A4E]">
        ...
        <div className="lg:col-span-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <ResponsiveContainer width="100%" height={320}>
            <AreaChart data={data.chartData.revenue}>
              ...
              <Area type="monotone" dataKey="value" stroke="#006A4E" strokeWidth={2} fill="url(#revenueGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={weeklyData}>
              ...
              <Tooltip contentStyle={{ backgroundColor: '#1F2937', border: 'none', borderRadius: '8px', color: '#fff', fontSize: '12px' }} />
              <Bar dataKey="sales" fill="#006A4E" radius={[4, 4, 0, 0]} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
            ...
            <button className="text-xs text-[#006A4E] dark:text-emerald-400 hover:underline font-medium flex items-center gap-1">
