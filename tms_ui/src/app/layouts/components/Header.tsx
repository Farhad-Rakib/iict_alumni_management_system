...
import { ROLE_LABELS } from '../../../core/auth/rbac';
...
const NotificationItem: React.FC<{
  ...
  <div
    className={`flex items-start gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer ${
      !n.read ? 'bg-[#E8F4F0] dark:bg-emerald-900/10' : ''
    }`}
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                  ...
                  {unreadCount > 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-[#006A4E] dark:text-emerald-400 hover:underline"
                    >
          ...
          <div ref={userRef} className="relative ml-1">
            ...
            >
              {user?.avatar ? (
                ...
                <div className="w-8 h-8 rounded-full bg-[#006A4E] flex items-center justify-center">
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 capitalize">{user?.role ? (ROLE_LABELS[user.role] || user.role) : ''}</p>
              </div>
            </button>
